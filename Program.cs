...
namespace SunumKonulari
{
    class Program
    {
        ...
        //15 ad ve 15 soyaddan kişi oluşturan metot
        ...
        }//Kullanıcıdan aldığı kişi sayısını kontrol eden metot
        ...
        {   
            ...
            return n;
        }//Kullanıcıdan kişi sayısını alan metot
        static int kisiSayisi()
        {
            ...
            return kisiSay;
        }     //Öğrencleri sunu konularına eşit yüzde ile atayan metot
        ...
        }  //Sunu konularına rastgele eşit yüzde ile atanmış kişileri tablo şeklinde bastıran metot
